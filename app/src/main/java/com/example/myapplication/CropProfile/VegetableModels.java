...
public class VegetableModels {
    ...
    public VegetableModels() {
    }

    public VegetableModels(Integer profile_id, String crop_name, Integer min_moisture, Integer max_moisture, Integer min_wlevel, Integer max_wlevel, Integer cat_id) {
